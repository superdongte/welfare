...
<script>
	$(function(){
		$("#btnAdd").click(function(){
			...
			var jsonBody = {userid:userid, userpw:userpw, username:username, tel:tel,birth:birth, email:email}
			if(id == ""){
				alert("아이디를 입력해주세요")
				return false;
			}
...
<body>
    ...
    <div class="col-sm-6">
    <h2>회원가입</h2>
     <!-- <form action="dd" method="get" id="f1"> --> 
        <table class="table table-boardered">
            <tr>
                <th>아이디</th>
                <td><input type="text" class="form-control" name="id" placeholder="id를 넣으세요" id="id"></td>
                <td><input type="button" class="form-control" value="중복체크" id="dup"></td>                   
            </tr>
            <tr>
                <th>패스워드</th>
                <td><input type="password" class="form-control" name="pass1" placeholder="비밀번호는 영문만 넣어주세요" id="userpw"></td>      
            </tr>
            ...
            <tr>
              ...
              <tr>
                <th>이름</th>
                <td><input type="text" class="form-control" name="name" placeholder="한글이름을 입력해주세요" id="name"></td>        
              </tr>
            ...
            <tr>
                <td colspan="2">
                <input type="button" class="btn btn-primary" value="전송" id="btnAdd">
